...
public class ProjectManagementPage implements Page {
    ...
    @FindBy(xpath = "//*[@id=\"app\"]/div/section/section/section/section/main/div/div[1]/div[2]/button")
    @CacheLookup
...
//        WebElement deleteIcon= line.findElements(By.tagName("div")).get(9);
//        System.out.println(webDriver.findElement(By.xpath("/html/body")).findElements(By.tagName("div")).size());
        Actions chain = new Actions(webDriver);
