...
public class ChangeToEndPage extends ProjectManagementPage {
    public ChangeToEndPage(Page page) {
        super(page);
        pauseOperation(1500);
    ...
    public WebElement findProjectStatusChangeDialog(){
        ...
        for (int i=0;i<list.size();i++) {
            ...
            if (  e.getAttribute("aria-label") !=null&&e.getAttribute("aria-label").equals( "结束项目")) return e;
        }
        return null;
    }
