...
public class FunctionEditPage extends FunctionPage {
    public FunctionEditPage(ProjectDetailPage p){
        super(p);
    ...
    public FunctionEditPage(FunctionPage p) {
        super(p);
        pauseOperation(500);
    ...
    public WebElement findFuncDialog(){
        ...
        for (int i=0;i<list.size();i++) {
            ...
            if (  e.getAttribute("aria-label") !=null&&e.getAttribute("aria-label").equals( "编辑功能")) return e;
        }
        return null;
    }
    ...
    public FunctionEditPage inputFuncName(String name){
        functionNameInput.clear();
        functionNameInput.sendKeys(name);
        return this;
    }
    public FunctionEditPage inputFuncPerson(String name){
